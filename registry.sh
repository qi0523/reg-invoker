...
sudo nerdctl pull qi0523/action-dotnet-v3.1:obd
...
sudo nerdctl pull qi0523/action-nodejs-v14:obd
...
sudo nerdctl pull qi0523/action-python-v3.9:obd
...
sudo nerdctl pull qi0523/action-php-v7.4:obd
...
sudo nerdctl pull qi0523/action-swift-v4.2:obd
sudo nerdctl tag qi0523/action-swift-v4.2:obd $HOST_ETH0_IP:35000/openwhisk/action-swfit-v4.2:obd
...
sudo nerdctl pull qi0523/python2action:obd
...
sudo nerdctl pull qi0523/java8action:obd
